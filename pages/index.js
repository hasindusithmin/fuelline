  ...
  return (
    <>
      ...
      <div className="w3-main w3-padding-large" style={{ marginLeft: '40%' }}>
        ...
        <div className='w3-row w3-padding w3-margin-bottom w3-card-4 w3-round-xlarge'>
          ...
          <div className='w3-third w3-center w3-padding'>
            <Link href="#" className='w3-button w3-light-grey w3-round-large w3-xlarge w3-margin-left'>🔍 <span className='w3-tag w3-small'>NEARME</span></Link>
          </div>
          <div className='w3-third w3-center w3-padding'>
            <Link href="#" className='w3-button w3-light-grey w3-round-large w3-xlarge w3-margin-left'>® <span className='w3-tag w3-small'>SIGNUP</span> </Link>
          </div>
          <div className='w3-third w3-center w3-padding'>
            <Link href="#" className='w3-button w3-light-grey w3-round-large w3-xlarge w3-margin-left'>➲ <span className='w3-tag w3-small'>LOGIN</span></Link>
          </div>
